            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  placeholder="e.g., Central Park, Delhi or Near Metro Station"
              ...
              <div className="flex gap-4 mb-3">
                <label className="flex items-center">
                  <input
                    ...
                    className="mr-2"
                  />
                  <span className="text-sm">Free (Community help)</span>
                </label>
                <label className="flex items-center">
                  <input
                    type="radio"
              ...
              {formData.compensation === "paid" && (
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-8 pr-4 py-3 border rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent ${
